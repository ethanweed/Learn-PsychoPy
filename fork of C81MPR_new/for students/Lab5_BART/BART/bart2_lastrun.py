...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.71.01), December 15, 2011, at 11:15
...
expInfo={'participant':'', 'group (A/B)':'', 'digit ratio':'','gender (m/f)':'','age':'','session':'005'}
...
logFile=psychopy.log.LogFile(filename+'.log', level=psychopy.log.DATA)
...
trials=data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=u'/Users/jwp/Dropbox/c81mpr_new/for students/Lab5_BART/BART/bart2.psyexp',
