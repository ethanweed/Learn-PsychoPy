...
stimulus=visual.PatchStim(win=win, tex=stimFile, mask='none',
    ori=0, pos=[xPos, yPos], size=[200,200], sf=None, phase=0.0,
    color='white', colorSpace='rgb',
...
#set up handler to look after randomisation of trials etc
trials=data.TrialHandler(nReps=4.0, method='random', extraInfo=expInfo, 
    trialList=data.importTrialList('trialTypes.xlsx'))
...
#completed 4.0 repeats of 'trials' repeats
